/**
* @file parser.c
* @brief      Module du parser, lis les arguments et les prépares pour la suite du traitement
...
/**
* @brief      Test si une chaine de caractères correspond à l'expression régulière
*
* @param      argc La chaine a tester
* @param      argv L'expression régulière
*
...
* @param      args_size La taille du tableau des arguments, pointeur qui sera mis à jour.
*
...
argument_t* parse_arg(int argc, char** argv, int* args_size) {
  ...
  list_t* arg_list = larg_new_list(); //La liste des arguments
